...
permalink: /aspace/digital-objects
layout: default
...
---
# Digital Objects
![digital objects](../aspace/Images/58-digital-objects.png)
...
_Digital Objects_ in ArchivesSpace are records that describe audio and moving image (AMI) files. Digital Objects should only be created via import from the MMS, and should not be manually created.