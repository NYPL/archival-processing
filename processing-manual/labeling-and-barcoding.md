...
You should wait to print labels until after your finding aid has been approved in case you need to make any changes. Before you print your labels, make sure the collection title and [call number](https://nypl.github.io/archival-processing/processing-manual/processing-proposal/#division-call-number-dacs-21) are both correct, and that there is a call number in the identifier field. 
