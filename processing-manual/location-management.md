...
| Collection rehoused into new containers. | [Deactivate](../processing-manual/updating_processed_object_records_in_SPEC.md) the old containers in SPEC. |
...
Below are instructions on how to update locations using the Object Barcode App and from the Object Search screens in SPEC. The [SPEC Objects Manual](https://nypl.github.io/pres-docs/spec/spec.html) also has detailed instructions on how to perform all these tasks, as well as a section about [location](https://nypl.github.io/pres-docs/spec/specAcquisitionsLocations.html) management.
...
![SPEC Objects Barcode Menu](../processing-manual/images/08-Objects-barcode-menu.png)

On the _Object Barcode App_ screen, scan in the barcode of the object whose location you need to update.

![SPEC Object Barcode App](../processing-manual/images/09-Object_Barcode_App.png)
...
![Scan Location](../processing-manual/images/10-Scan_location.png)
...
![Location Message](../processing-manual/images/11-Location_Message.png)
...
![SPEC Bulk Edit Menu](../processing-manual/images/12-SPEC_Bulk_Edit.png)

Once all the objects are selected, choose the _Action_ menu again and select _Update object locations_.

![Update Object Locations](../processing-manual/images/13-Update_object_locations.png)

A dialog box will appear notifying you that the current object locations will be deactivated. Select _OK._

![Object Bulk Deactivate](../processing-manual/images/14-object_bulk_deactivate.png)
...
![Update Bulk Locations](../processing-manual/images/15-Update_location_bulk.png)

Once you have entered the new barcode, select the green _Apply Location to Selected Objects_ button.

![Apply Locations Button](../processing-manual/images/16-Apply_locations_button.png)
...
![Batch Edit All](../processing-manual/images/17-Batch_Edit_All.png)
...
![sort objects](../processing-manual/images/18-Sort_objects.png)
...
![Update Location](../processing-manual/images/19-Update_Location.png)

Once you scan in the new location, a dialog box will appear.

![Make Current Location Inactive](../processing-manual/images/20-Make_Current_Location_Inactive.png)
