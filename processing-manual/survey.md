---
title: Survey
permalink: /processing-manual/survey/
layout: default
...
When you remove containers from the stacks, make sure to update their locations in SPEC using the location barcode for your workspace. See the section of this manual on [Location Management](/archival-processing/processing-manual/location-management.md) for more information. 
