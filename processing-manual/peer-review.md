---
title: Peer Review
permalink: /processing-manual/peer-review/
layout: default
...
When you are ready to share your finding aid with your colleagues, generate a pdf of the finding aid in ASpace. The ASpace User Guide section on [exports](/archival-processing/aspace/aspace.md) explains how to create a PDF of your finding aid. Add the PDF to the [shared finding aids folder 🔒](https://drive.google.com/drive/folders/1ixJ2_0HxUCAJQXx57Q3RB6pYVLnmwZC7?usp=drive_link) in Google Drive. Make sure to add your finding aid to the current month's folder, or make a folder for the current month if there is not one yet. Once the month ends, that folder will be added to the current fiscal year's _reviewed_ folder. 
