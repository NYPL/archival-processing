...
For collections containing audio and moving image, use the correct division statement, both in the front matter, and at the level immediately above the audio and moving image components. See the [Description of Audio and Moving Image Material in ArchivesSpace](processing-manual/description-of-ami-in-aspace.md) section of this documentation for each division's access note language. 
