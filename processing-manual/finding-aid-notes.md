...
For collections containing audio and moving image, use the correct division statement, both in the front matter, and at the level immediately above the audio and moving image components. See the [Description of Audio and Moving Image Material in ArchivesSpace](dhttps://nypl.github.io/archival-processing/processing-manual/archival-description/description-of-ami-in-aspace/#audio-and-moving-image-access-notes-in-archivesspace) section of this manual for each division's access note language. 
