...
In ArchivesSpace, controlled access terms are divided into [_Agents_](#agents) (personal names, corporate bodies, family names) and [_Subjects_](#subjects) (topics, genre/form, occupations), which are used as access points in the [archives portal](http://archives.nypl.org/), the [NYPL catalog](https://browse.nypl.org/iii/encore/homepage), the [NYPL research catalog](https://www.nypl.org/research/research-catalog), and in [WorldCat](https://www.worldcat.org/). Once a finding aid is complete, the MARC XML is exported in order to create a record in WorldCat and in Sierra. It is important that your agents and subjects are formed correctly, otherwise the terms will not properly validate. All finding aids must include controlled access terms. The [ArchivesSpace Documentation](/archival-processing/aspace) contains detailed information about how to add agents and subjects to your finding aid, as well as how to create and add new terms. The section of this documentation on [Inclusive Description](/archival-processing/processing-manual/inclusive-description.md) provides further explanation on how to choose access terms that are not offensive or harmful. 
...
![main entry](../processing-manual/images/59-main-entry.png)
...
![creator/contributor](../processing-manual/images/60-creator-contributor.png)
...
![agent as subject](../processing-manual/images/61-agent-subject.png)
...
![subdivision](../processing-manual/images/62-subdivision.png)
...
![LC note](../processing-manual/images/63-LC-note.png)
...
![LC identifer](../processing-manual/images/64-LC_identifer.png)

**ULAN**

![ULAN](../processing-manual/images/65-ULAN.png)

**SNAC**

![SNAC](../processing-manual/images/66-SNAC.png)

**VIAF**

![VIAF](../processing-manual/images/67-VIAF.png)
...
![ASpace Agent](../processing-manual/images/68-ASpace-agent.png)
...
![ASpace Agent with Dates](../processing-manual/images/69-ASpace-Agent-Dates.png)

Other disambiguation terms should be entered into the _qualifier_ field, as illustrated below.

![ASpace Agent with Qualifier](../processing-manual/images/70-ASpace-Agent-Qualifier.png)
...
![LC Record RDA](../processing-manual/images/71-Belafonte-RDA.png)

![MARC Record RDA](../processing-manual/images/72-Belafonte-RDA-MARC.png)

![Agent Record RDA ASpace](../processing-manual/images/73-Belafonte-Agent-ASpace.png)
...
![Local Terms ASpace](../processing-manual/images/76-Local-terms-ASpace.png)
...
![Local Agent in ASpace](../processing-manual/images/77-local-agent-ASpace.png)
...
There is more information below about which controlled vocabularies to use for specific types of subjects, the way in which the term will appear in the portal, and the equivalent MARC field. If you need to create a new subject, see the section of this documentation about [Creating New Subjects](# Creating-New-Subjects).
...
![complex subjects ASpace](../processing-manual/images/78-complex-subjects-ASpace.png)
...
![LC Module Example](../processing-manual/images/79-LC-Module.png)
...
![LC Collection Membership](../processing-manual/images/80-LC-collection-membership.png)
...
![Geographic Subdivision LC](../processing-manual/images/81-LC-geographic-subdivision.png)
...
![Geographic invalid LC](../processing-manual/images/82-LC-Geographic-not-valid.png)

Typically, geographic subdivisions will include a state, followed by the city. In ASpace it should be entered like this:

![ASpace Geographic Subdivision](../processing-manual/images/83-ASpace-Geographic-subdivision.png)
